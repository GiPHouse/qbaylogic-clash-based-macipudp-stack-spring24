...
model
  ...
  -> [PacketStreamM2S dataWidth ()]
model padBytes fragments =
  concatMap (upConvert . setLasts . insertPadding) $ chunkByPacket $ downConvert fragments
 where
...
prop_paddinginserter_d1
  , prop_paddinginserter_d2
  , prop_paddinginserter_d5
  , prop_paddinginserter_d50
    :: Property

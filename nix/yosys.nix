...
, makeWrapper, pkg-config, python3, readline, symlinkJoin, tcl, zlib
, yosys }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    owner = "yosysHQ";
    repo = "yosys";
    rev = "4897e89547d2e53ebc015052d1b3cad2727ff9a9";
    hash = "sha256-BhKCMROwElxVQ9beN59SNM5GeuqjXoDZw9PVgkgH/BQ=";
  };

  enableParallelBuilding = true;
  nativeBuildInputs = [ pkg-config bison flex ];
  buildInputs = [ tcl readline libffi python3 zlib ];
